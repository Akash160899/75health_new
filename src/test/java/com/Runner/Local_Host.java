...
public class Local_Host extends Base_Class {
	...
	private void HealthRec() throws InterruptedException, IOException {
		...
		WebElement rds = ww.until(ExpectedConditions.presenceOfElementLocated(
				By.xpath("//div[text()='RXNORM: testosterone enanthate 100 MG/ML Injectable Solution-100']")));
		...
		WebElement rdss = ww.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
				"//div[text()='RXNORM: testosterone enanthate 100 MG/ML Injectable Solution-100']//following::div[6]/div[2]//following::div[1]/div[1]/div[5]/div[2]/input")));
		visbility(driver, rdss, 60);
		rdss.clear();
		rdss.sendKeys("500");
		WebElement sql = driver.findElement(By.xpath(
				"//div[text()='RXNORM: testosterone enanthate 100 MG/ML Injectable Solution-100']//following::div[6]/div[2]//following::div[1]/div[2]/div[1]/button[3]"));
	...
	private void BillingModule() throws InterruptedException {
		...
		// driver.navigate().refresh();
		WebElement trp9 = driver.findElement(By.xpath(
	...
	private void Settings() throws InterruptedException, IOException {
		...
		for (WebElement w : setfav1) {
			if (w.getText().trim().equals("Problems")) {
				...
				WebElement ps1 = driver.findElement(
						By.xpath("(//div[@id='physical-module'])[1]/div[1]/div//following::td[4]/span[2]"));
				visbility(driver, ps1, 60);
				javascriptclick(ps1);
				WebElement ps2 = driver.findElement(
						By.xpath("(//input[contains(@placeholder,'Enter name of the examined part here')])[2]"));
				visbility(driver, ps2, 60);
				sendkeys(ps2, "physical examin");

				WebElement ps3 = driver
						.findElement(By.xpath("(//textarea[contains(@placeholder,'Enter finding details here')])[2]"));

				visbility(driver, ps3, 60);
				sendkeys(ps3, "hello");
				WebElement ps4 = driver
						.findElement(By.xpath("(//textarea[contains(@placeholder,'Enter notes summary')])[2]"));
				visbility(driver, ps4, 60);
				sendkeys(ps4, "jsp");
				WebElement ps5 = driver.findElement(
						By.xpath("(//div[@id='physical-module'])[1]/div[3]/div/div/div[2]/div[8]/div/div"));
				visbility(driver, ps5, 60);
				javascriptclick(ps5);
				sleep(2500);
				WebElement ps8 = driver.findElement(By.xpath("(//div[text()='physical examin'])[1]"));
				visbility(driver, ps8, 60);
				javascriptclick(ps8);

				WebElement delpys = driver.findElement(
						By.xpath("(//div[@id='physical-module'])[1]/div[3]/div/div/div[1]/div[2]/span[1]"));
				visbility(driver, delpys, 60);
				javascriptclick(delpys);

				WebElement ps6 = driver.findElement(By
						.xpath("(//span[contains(text(),'Favorite Physical Examinations')])[1]//parent::div/span[1]"));
				visbility(driver, ps6, 60);
				javascriptclick(ps6);
			}
		...
		List<WebElement> numberofformspresent = driver.findElements(By.xpath("//div[@id='FormsKpop2']/div[2]/div"));

		// (//div[@class='form-pop-body'])[1]/div/div[1]
		int ffs = numberofformspresent.size();
		...
		for (int imp = 3; imp <= ffs; imp++) {
			...
			// u = 1 + i;
			WebElement rtt = driver.findElement(
					By.xpath("//div[@id='FormsKpop2']/div[2]/div[" + imp + "]//following::div[5]/span[2]"));
			// (//div[@class='form-pop-body'])[1]/div[" + imp +
			// "]//following::div[5]/span[2]

			// div[@id='FormsKpop2']/div[2]/div[3]//following::div[5]/span[2]

			if (rtt.getText().trim().equals("form100")) {
				System.out.println("condtion mets");
				visbility(driver, rtt, 60);
				rtt.click();
		...
		sendkeys(f2, "form100");// .sendKeys("form100");
